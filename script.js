...
const translations = {
    ...
    secondaryMissionExp: "Our secondary mission includes several sensors to detect essential data for any self-respecting space mission: temperature and pressure (primary), accelerometer, gyroscope, magnetometer, volatile organic compound detection, humidity. There will also be a <b>Geiger-Muller</b> counter to measure ionising radiation at various altitudes. Additionally, an in-flight stabilization system will keep the CanSat's roll stable throughout the descent. All the main sensors will be housed in a <b>Flight Computer</b> that we will design. This system will have communication ports for the most commonly used protocols and an integrated GPS. Everything will be controlled with an ESP32. It will also include an H-bridge to control a DC motor, and power supplies for the ESCs of the brushless motors, which are needed for in-flight stabilisation. All data will be both transmitted to the groundstation and stored on an on-board flash memory.",
    goBackBtn: "Go Back",
    ...
    teamFirstUpdate: "We are delighted and honored to announce that our team has been <b>selected</b> for the Italian CanSat 2024-2025 competition! This is a very <b>special moment</b> because it demonstrates the result of months of hard work and planning, and we are confident that <b>we will meet expectations</b>, bringing our project to a successful conclusion. Now, we face months of advanced design and testing, working to identify any issues that may arise in the future. Thank you all for your trust. See you in Bologna!",
    ...
    nizarDesc: "Nizar is passionate about space, from engineering to the discoveries of the universe, and he has decided to participate in this competition to connect even more with this passion. He is currently studying <b>computer science</b> and has previously created and developed several electronics projects, starting with the simple yet essential <b>Arduino Uno</b> and reaching the current and powerful <b>ESP32</b>. In this project, he will be responsible for developing the software for the <b>control algorithms</b> and will also contribute to the electronics by designing the satellite’s <b>Flight Computer</b>. According to him, <i>“if humans reached the Moon with a 2 MHz computer, then with an Arduino Uno, anything is possible.”</i>",
    patrizioDesc: "Patrizio Aloisio is our <b>professor</b> of telecommunications and <b>mentor</b> for this project. With decades of experience in electronics, he is the ideal person to rely on to achieve our goals. With his technical support and knowledge, we will be able to develop and advance the CanSat more efficiently, allowing us to <b>learn from his experience</b>.",
    patrizioSubHead: "Professor and Mentor",
    patrizioProfession: "Mentor",
    simoneSubHead: "COM Engineer",
    simoneDesc: "Passionate about <b>programming</b> and <b>practical engineering</b>, Simone is responsible for <b>satellite communication</b> and <b>software development</b> in the CanSat project. He works to ensure smooth communication between the CanSat and the <b>ground station</b>. His role consists of developing the software that processes and transmits telemetry data, enabling real-time monitoring and analysis of the satellite’s performance. By combining technical expertise with a hands-on DIY approach, he contributes to innovation and problem-solving necessary for a successful CanSat mission.",
    skyDesc: "Sky contributed to this project by developing and implementing the <b>Kalman filter</b> for <b>sensor data processing</b>. Working in C++, he tested and applied the filter to improve the accuracy of pressure, altitude, and acceleration measurements. Thanks to this optimization, data analysis during the flight has become more reliable and effective.",
    skySubHead: "Software Engineer",
    raptorDesc: "The <b>Raptor Flight Computer</b> is the brain of our project, responsible for controlling every single aspect of the CanSat. It has several integrated sensors: BMP280, BME680, ENS210, and CCS811 for <b>temperature</b>, <b>pressure</b>, <b>volatile organic compound</b> (VOC) measurement, and <b>humidity</b>; MPU6500, MPU6050, and QMC5883L for <b>accelerometer</b>, <b>gyroscope</b>, and <b>magnetometer</b>. All computational power comes from an <b>ESP32-S3</b>. There will also be communication ports for the most commonly used protocols: <b>UART</b>, <b>I2C</b>, and <b>SPI</b>. The system also includes an <b>H-bridge</b> with the L293DD to control some DC motors and power supplies for the ESCs of the brushless motors. All data will be transmitted to the ground and stored on onboard <b>flash memory</b> and an <b>SD card</b>.",
    fiveFebTwoFive: "FEBRUARY 05, 2025",
    headVDAOrienta: "SKYCHASERS AT VDA ORIENTA",
    teamSecondUpdate: "We were happy to have participated in the regional event <b>VDA Orienta</b>, which this year, for the first time, guided middle school students in choosing their high school. Representing the <b>I. Manzetti Technical Institute</b>, specifically the <b>Information Technology and Telecommunications</b> program, we provided the students with not only a general overview of the school but also a presentation of our CanSat project, sparking curiosity and interest among them. We showed them the development process behind such a project, from the website to the prototyping hardware, all of which will ultimately lead to the creation of a fully functional and operational mini-satellite. We can't wait to move on to the next step of development.",
    launchYourName: "Send Your Name",
    launchYourNameHomeHead: "SEND YOUR NAME",
    ...
    launchYourName: "Invia il tuo nome",
    launchYourNameHomeHead: "INVIA IL TUO NOME",
  ...
  de: {
    ...
    teamFirstUpdate: "Wir sind begeistert und geehrt, bekannt zu geben, dass unser Team für den italienischen CanSat-Wettbewerb 2024-2025 <b>ausgewählt</b> wurde! Dies ist ein ganz besonderer Moment, da er das Ergebnis unserer harten Arbeit nach Monaten der Planung bestätigt, und wir sind zuversichtlich, dass <b>wir die Erwartungen nicht enttäuschen</b> und unser Projekt erfolgreich abschließen werden. Jetzt stehen uns Monate fortgeschrittener Entwicklung und Tests bevor, in denen wir versuchen, mögliche Probleme zu identifizieren, die in der Zukunft auftreten könnten. Vielen Dank für euer Vertrauen. Wir sehen uns in Bologna!",
    ...
    launchYourName: "Senden Sie Ihren Namen",
    launchYourNameHomeHead: "SENDEN SIE IHREN NAMEN",
  ...
  fr: {
    ...
    launchYourName: "Envoyez votre nom",
    launchYourNameHomeHead: "ENVOYEZ VOTRE NOM",
  ...
  es: {
    ...
    launchYourName: "Envíe su nombre",
    launchYourNameHomeHead: "ENVÍE SU NOMBRE",
